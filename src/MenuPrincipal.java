...
public class MenuPrincipal {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (op) {
                case 1 ->
                    listaDePacientes.imprimirListaPacientes();
                case 2 ->
                    listaDePacientes.agregarPaciente(sc);
                case 3 ->
                    listaDePacientes.borrarPaciente(sc);
                case 4 ->
                    listaDePacientes.organizarListaPorID(true);
                case 5 ->
                    listaDePacientes.organizarListaPorNombre(true);
                case 6 -> {
                    return;
                }
                default ->
